...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'ps4Controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/avp/avp-repo/avp-ros/install/${idir}'.  Ask the maintainer 'avp <avp@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/avp/avp-repo/avp-ros/install/lib;/home/avp/avp-repo/avp-ros/devel/lib;/opt/ros/hydro/lib)
